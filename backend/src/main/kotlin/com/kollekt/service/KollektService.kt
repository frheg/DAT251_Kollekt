...
class KollektService(
        ...
        fun createExpense(request: CreateExpenseRequest, actorName: String): ExpenseDto {
                ...
                val requestedParticipants =
                        request.participantNames
                                ...
                                .toSet()
                val participants =
                        if (requestedParticipants.isEmpty()) collectiveMembers
                        else requestedParticipants
        ...
        private fun calculateBalances(
                ...
                expenses.forEach { expense ->
                        val participants =
                                (if (expense.participantNames.isEmpty()) memberSet
                                        else expense.participantNames)
                                        .intersect(memberSet)
